...
```sh
mkimage -A riscv -O linux -T kernel -C none -a 0x90000000 -e 0x90000000 -d loader.img uImage
```

You will then want to load `uImage` instead, and then run the following U-Boot command
